...
LOGGER_NAME = "train_drunet"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train DRUNet (UNetRes) for TEMPEST denoising")
...
def main() -> None:
    ...
    if args.resume:
        ...
        if ckpt_model_name and ckpt_model_name != "drunet":
            raise ValueError(f"Checkpoint model '{ckpt_model_name}' != 'drunet'.")
    ...
    logger.info("Starting DRUNet training")
