...
from network_unet import UNetResEMA


LOGGER_NAME = "train_drunet_ema"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train DRUNet with EMA (UNetResEMA) for TEMPEST denoising")
...
def main() -> None:
    ...
    if args.resume:
        ...
        if ckpt_model_name and ckpt_model_name != "drunet_ema":
            raise ValueError(f"Checkpoint model '{ckpt_model_name}' != 'drunet_ema'.")
    ...
    logger.info("Starting DRUNet with EMA training")
