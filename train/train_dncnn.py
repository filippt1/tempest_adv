...
LOGGER_NAME = "train_dncnn"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train DnCNN for TEMPEST denoising")
...
def main() -> None:
    ...
    if args.resume:
        ...
        if ckpt_model_name and ckpt_model_name != "dncnn":
            raise ValueError(f"Checkpoint model '{ckpt_model_name}' != 'dncnn'.")
    ...
    logger.info("Starting DnCNN training")
